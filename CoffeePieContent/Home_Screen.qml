    ...
    StackView {
        ...
        Image {
            ...
            Button {
                ...
                Connections {
                    target: buttonBalance
                    onClicked: stackView.push("Payment_Gateways.qml")
                }
            }
            ...
            Text {
               ...
               // color: "#ffffff"
                ...
                color: (credits !== "" && parseFloat(credits) < 0) ? "#8B4513" :"#ffffff" // brown if credits < 0
                text: credits !== "" ? credits + " Cr" : "..."

                font.pixelSize: 32
                horizontalAlignment: Text.AlignLeft
                verticalAlignment: Text.AlignVCenter
                Component.onCompleted: {
                    var result = myMachine.getMyCredits(myMachine.userToken);
           ...
           Text {
             ...
             Component.onCompleted: {
                   var result = myMachine.getMyUserName(myMachine.userToken);
            ...
            StackView {
                ...
                width: 1920
                height: 824
                initialItem: "StackViewBasic2.qml"
                  z: 2 // Opcional, asegura que esté al frente
            }
        }
        ...
        Label {
            ...
            Button {
                ...
                icon.height: 120
                icon.width: 120
                icon.source: "images/Btn_Reload.png"
                flat: true
                onClicked: {
                    var result = myMachine.getMyCredits(myMachine.userToken);
                    if (result && result.credits !== undefined) {
                        txtBalance.credits = result.credits;
                    } else {
                        txtBalance.credits = "-";
                    }
                    // Refresh VM list in StackViewBasic2
                    if (stackViewHome.currentItem && stackViewHome.currentItem.fetchAndRenderVMs) {
                        stackViewHome.currentItem.fetchAndRenderVMs();
                    }
                }
            }
        }
        ...
        Switch {
            ...
            Connections {
                target: switchBasicAdvanced
                onToggled: if(switchBasicAdvanced.checked){stackViewHome.push("StackViewAdvanced.qml")
                           }else{
                               stackViewHome.pop()
                           }
            }
        ...
        Button {
            ...
            icon.color: "#eaeaea"
            flat: true
            onClicked: stackView.push("Main_Menu.qml", StackView.Immediate)
        }
        ...
        TextField {
            ...
            placeholderText: qsTr("Buscar máquina")
            inputMask: ""
            font.pointSize: 20
